...
//                Object arr[]=alOrderList.toArray();
                ...
                String doc = userPhoneNumber.substring(0, 4);
                doc = doc + ph.substring(0,4);



                FirebaseFirestore.getInstance().collection("Orders").document(doc).set(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
    ...
    private boolean checkOrderID(int order_id)
    {
