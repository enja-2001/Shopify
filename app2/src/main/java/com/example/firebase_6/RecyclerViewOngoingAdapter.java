...
public class RecyclerViewOngoingAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ArrayList<MyOrder> al;
    Context context;
    String phoneNumber;


    public RecyclerViewOngoingAdapter(ArrayList<MyOrder> al,Context context){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tvOngoingEndingDate.setVisibility(View.GONE);
